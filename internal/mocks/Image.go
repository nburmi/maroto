...
import consts "github.com/nburmi/maroto/pkg/consts"
import internal "github.com/nburmi/maroto/internal"
import mock "github.com/stretchr/testify/mock"
import props "github.com/nburmi/maroto/pkg/props"
...
// AddFromFile provides a mock function with given fields: path, cell, prop
func (_m *Image) AddFromBytes(imageData []byte, cell internal.Cell, prop props.Rect, extension consts.Extension) error {
	ret := _m.Called(imageData, cell, prop, extension)

	var r0 error
	if rf, ok := ret.Get(0).(func([]byte, internal.Cell, props.Rect, consts.Extension) error); ok {
		r0 = rf(imageData, cell, prop, extension)
	} else {
		r0 = ret.Error(0)
	}
